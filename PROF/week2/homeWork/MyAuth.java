...
public class MyAuth {
    ...
    private boolean readListOfUsers()  {

        Scanner sc;
        try {
            sc = new Scanner(new FileReader("d:\\Illia\\JAVA\\Курсы\\WorkersSave.txt"));
        } catch (FileNotFoundException e) {
            System.err.println("Файл не існує або неправельний шлях");
    ...
    public static void main(String[] args) {
      ...
      //  myAuth.readListOfUsers();

        myAuth.readListOfUsers();

        myAuth.add("Partizanin","95999599w");
        myAuth.add("Partizanin","95999599w");
